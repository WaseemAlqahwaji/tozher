...
class InterestGetCubit extends Cubit<BaseState<List<Interest>>> {
  final InterestRepo _interestRepo;

  InterestGetCubit({required InterestRepo interestRepo})
  ...
  void getInterests() async {
    ...
    final res = await _interestRepo.getInterests();
